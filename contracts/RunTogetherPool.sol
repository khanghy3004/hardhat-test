...
contract RunTogetherPool is Ownable, ReentrancyGuard {
    ...
    uint256 public compoundRate = 1; // compound every 1 block
            ...
            ABDKMath64x64.mulu(
                pow(
                    ABDKMath64x64.add(
                        ...
                        ABDKMath64x64.divu(ratio, blockPerYear / compoundRate * baseRate)
                    ),
                    totalBlock / compoundRate
                ),
                principal
            );
    }
    ...
    function setCompound(bool _status, uint256 _compoundRate) external onlyOwner {
        isCompound = _status;
